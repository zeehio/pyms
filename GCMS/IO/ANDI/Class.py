...
class ANDI_reader(object):
    ...
    def __init__(self, file_name):
        ...
        """
        @summary: Initialize the reader for ANDI-MS NetCDF files
        ...
        print " -> Reading netCDF file '%s'" % (self.__file_name)
